		...
		{"(# A\na # B\nas # C\nb # D\n)", func(t *test, tk Tokens) { // 4
			t.Output = WithItem{
				...
				Target: &Target{
					...
					Comments: [2]Comments{{tk[9]}, {tk[13]}},
					Tokens:   tk[9:14],
				},
				Comments: [2]Comments{{tk[1]}, {tk[5]}},
				Tokens:   tk[1:14],
...
func TestFuncDefinition(t *testing.T) {
	doTests(t, []sourceFn{
		...
		{"def a():\n\treturn b", func(t *test, tk Tokens) { // 10
			t.Output = FuncDefinition{
				FuncName: &tk[2],
				ParameterList: ParameterList{
					Tokens: tk[4:4],
		...
		{"def a():\n\treturn", func(t *test, tk Tokens) { // 11
			t.Output = FuncDefinition{
				FuncName: &tk[2],
				ParameterList: ParameterList{
					Tokens: tk[4:4],
		...
		{"def a():\n\traise b", func(t *test, tk Tokens) { // 12
			t.Output = FuncDefinition{
				FuncName: &tk[2],
				ParameterList: ParameterList{
					Tokens: tk[4:4],
		...
		{"def a():\n\traise", func(t *test, tk Tokens) { // 13
			t.Output = FuncDefinition{
				FuncName: &tk[2],
				ParameterList: ParameterList{
					Tokens: tk[4:4],
		...
		{"def a():\n\tyield b", func(t *test, tk Tokens) { // 15
			t.Output = FuncDefinition{
				FuncName: &tk[2],
				ParameterList: ParameterList{
					Tokens: tk[4:4],
		...
		{"def a( # A\nb\n# B\n):c", func(t *test, tk Tokens) { // 16
			t.Output = FuncDefinition{
				...
				ParameterList: ParameterList{
					...
					Comments: [10]Comments{{tk[5]}, nil, nil, nil, nil, nil, nil, nil, nil, {tk[9]}},
					Tokens:   tk[5:10],
				},
				Suite: Suite{
					StatementList: &StatementList{
		...
		{"def a(# A\n# B\n\n# C\n# D\n):b", func(t *test, tk Tokens) { // 18
			t.Output = FuncDefinition{
				...
				Comments: [3]Comments{nil, {tk[4], tk[6]}, {tk[8], tk[10]}},
				Tokens:   tk[:15],
			}
		}},
		{"@a # A\n# B\n\n# C\n@b # D\n\n# E\n\n# F\ndef c( #G\n):d", func(t *test, tk Tokens) { // 19
			t.Output = FuncDefinition{
				Decorators: &Decorators{
					Decorators: []Decorator{
						{
		...
		{"def nonlocal():a", func(t *test, tk Tokens) { // 20
			t.Err = Error{
				Err:     ErrMissingIdentifier,
				Parsing: "FuncDefinition",
				Token:   tk[2],
		...
		{"def a(b=nonlocal):c", func(t *test, tk Tokens) { // 23
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{"def a()->nonlocal:b", func(t *test, tk Tokens) { // 24
			t.Err = Error{
				Err: Error{
					Err: wrapConditionalExpressionError(Error{
						Err:     ErrInvalidEnclosure,
		...
		{"def a():nonlocal", func(t *test, tk Tokens) { // 25
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{"def a() b", func(t *test, tk Tokens) { // 27
			t.Err = Error{
				Err:     ErrMissingColon,
				Parsing: "FuncDefinition",
				Token:   tk[6],
		...
		{"@(nonlocal)\ndef a(): b", func(t *test, tk Tokens) { // 28
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
	...
	doTests(t, []sourceFn{
		...
		{"class a(# A\n\n# B\n):b", func(t *test, tk Tokens) { // 12
			t.Output = ClassDefinition{
				...
				Comments: [3]Comments{nil, {tk[4]}, {tk[6]}},
				Tokens:   tk[:11],
			}
		}},
		{"class a(# A\nb\n# B\n):c", func(t *test, tk Tokens) { // 13
			t.Output = ClassDefinition{
				...
				Comments: [3]Comments{nil, {tk[4]}, {tk[8]}},
				Tokens:   tk[:13],
			}
		}},
		{"@a # A\n# B\n\n# C\n@b # D\n\n# E\n\n# F\nclass c():d", func(t *test, tk Tokens) { // 14
			t.Output = ClassDefinition{
				Decorators: &Decorators{
					Decorators: []Decorator{
						{
				...
				Comments: [3]Comments{{tk[16], tk[19]}},
				Tokens:   tk[:28],
			}
		}},
		{`class nonlocal:b`, func(t *test, tk Tokens) { // 15
			t.Err = Error{
				Err:     ErrMissingIdentifier,
				Parsing: "ClassDefinition",
				Token:   tk[2],
		...
		{`class a(nonlocal)`, func(t *test, tk Tokens) { // 17
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{`class a(b)`, func(t *test, tk Tokens) { // 18
			t.Err = Error{
				Err:     ErrMissingColon,
				Parsing: "ClassDefinition",
				Token:   tk[6],
		...
		{`class a:nonlocal`, func(t *test, tk Tokens) { // 19
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{"@nonlocal\nclass a:b", func(t *test, tk Tokens) { // 20
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
...
func TestTypeParam(t *testing.T) {
	doTests(t, []sourceFn{
		...
		{"# a comment\n# b comment\n\n# c comment\n** a # d comment", func(t *test, tk Tokens) { // 9
			t.Output = TypeParam{
				Type:       TypeParamVarTuple,
				Identifier: &tk[9],
	...
	doTests(t, []sourceFn{
		...
		{"(# A\na\n# B\n)", func(t *test, tk Tokens) { // 20
			t.Output = ParameterList{
				...
				Comments: [10]Comments{{tk[1]}, nil, nil, nil, nil, nil, nil, nil, nil, {tk[5]}},
				Tokens:   tk[1:6],
			}
		}},
		{"(a, # A\n/ # B\n\n# C\n)", func(t *test, tk Tokens) { // 21
			t.Output = ParameterList{
				...
				Comments: [10]Comments{nil, {tk[4]}, {tk[8]}, nil, nil, nil, nil, nil, nil, {tk[10]}},
				Tokens:   tk[1:11],
			}
		}},
		{"(a, # A\n* # B\nb # C\n\n# D\n)", func(t *test, tk Tokens) { // 22
			t.Output = ParameterList{
				...
				Comments: [10]Comments{nil, nil, nil, {tk[4]}, {tk[8]}, {tk[12]}, nil, nil, nil, {tk[14]}},
				Tokens:   tk[1:15],
			}
		}},
		{"(*a, # A\n**\n# B\nb # C\n\n# D\n)", func(t *test, tk Tokens) { // 23
			t.Output = ParameterList{
				...
				Comments: [10]Comments{nil, nil, nil, nil, nil, nil, {tk[5]}, {tk[9]}, {tk[13]}, {tk[15]}},
				Tokens:   tk[1:16],
			}
		}},
		...
		{"(# A\n# B\n\n# C\n\n#D\na # E\n\n#F\n, # G\n\n# H\n\n/# I\n\n# J\n, # K\n\n# L\n*# M\n\n# N\nb\n# O\n\n# P\n, # Q\n**# R\n\n# S\nc\n# T\n)", func(t *test, tk Tokens) { // 25
			t.Output = ParameterList{
				...
				Comments: [10]Comments{{tk[1], tk[3]}, {tk[17], tk[19]}, {tk[22], tk[24]}, {tk[28], tk[30]}, {tk[33], tk[35]}, {tk[39], tk[41]}, {tk[45]}, {tk[48], tk[50]}, nil, {tk[54]}},
				Tokens:   tk[1:55],
			}
		}},
