...
func TestEnclosure(t *testing.T) {
	doTests(t, []sourceFn{
		...
		{`(nonlocal for)`, func(t *test, tk Tokens) { // 32
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: wrapConditionalExpressionError(Error{
		...
		{`(nonlocal)`, func(t *test, tk Tokens) { // 33
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: wrapConditionalExpressionError(Error{
		...
		{`[nonlocal]`, func(t *test, tk Tokens) { // 35
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{`[a for b in c d]`, func(t *test, tk Tokens) { // 36
			t.Err = Error{
		...
		{`{nonlocal}`, func(t *test, tk Tokens) { // 37
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{`{a:nonlocal}`, func(t *test, tk Tokens) { // 38
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{`{*nonlocal}`, func(t *test, tk Tokens) { // 39
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{`{a for b in c d}`, func(t *test, tk Tokens) { // 40
			t.Err = Error{
