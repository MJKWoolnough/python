...
func TestSimpleStatement(t *testing.T) {
	doTests(t, []sourceFn{
		...
		{`yield a`, func(t *test, tk Tokens) { // 7
			t.InReturnable = true
			t.Output = SimpleStatement{
				Type: StatementYield,
		...
		{`raise a`, func(t *test, tk Tokens) { // 8
			t.Output = SimpleStatement{
				Type: StatementRaise,
		...
		{`break`, func(t *test, tk Tokens) { // 10
			t.IsBreakable = true
			t.Output = SimpleStatement{
				Type:   StatementBreak,
				Tokens: tk[:1],
		...
		{`continue`, func(t *test, tk Tokens) { // 11
			t.Err = Error{
				Err:     ErrInvalidStatement,
				Parsing: "SimpleStatement",
				Token:   tk[0],
		...
		{`continue`, func(t *test, tk Tokens) { // 12
			t.IsBreakable = true
			t.Output = SimpleStatement{
		...
		{`import a`, func(t *test, tk Tokens) { // 13
			t.Output = SimpleStatement{
		...
		{`lazy import a`, func(t *test, tk Tokens) { // 14
			t.Output = SimpleStatement{
				Type: StatementImport,
				ImportStatement: &ImportStatement{
					Lazy: true,
		...
		{`from a import b`, func(t *test, tk Tokens) { // 15
			t.Output = SimpleStatement{
				Type: StatementImport,
				ImportStatement: &ImportStatement{
		...
		{`lazy from a import b`, func(t *test, tk Tokens) { // 16
			t.Output = SimpleStatement{
				Type: StatementImport,
				ImportStatement: &ImportStatement{
					Lazy: true,
		...
		{`global a`, func(t *test, tk Tokens) { // 17
			t.Output = SimpleStatement{
		...
		{`nonlocal a`, func(t *test, tk Tokens) { // 18
			t.Output = SimpleStatement{
		...
		{`type a=b`, func(t *test, tk Tokens) { // 19
			t.Output = SimpleStatement{
				Type: StatementTyp,
		...
		{`lazy:b`, func(t *test, tk Tokens) { // 23
			t.Output = SimpleStatement{
				Type: StatementAnnotatedAssignment,
				AnnotatedAssignmentStatement: &AnnotatedAssignmentStatement{
					AugTarget: AugTarget{
		...
		{`assert nonlocal`, func(t *test, tk Tokens) { // 25
			t.Err = Error{
				Err: Error{
					Err: Error{
		...
		{`del nonlocal`, func(t *test, tk Tokens) { // 26
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{`return nonlocal`, func(t *test, tk Tokens) { // 27
			t.InReturnable = true
			t.Err = Error{
				Err: Error{
					Err: Error{
		...
		{`yield nonlocal`, func(t *test, tk Tokens) { // 28
			t.InReturnable = true
			t.Err = Error{
				Err: Error{
					Err: Error{
		...
		{`raise nonlocal from a`, func(t *test, tk Tokens) { // 29
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: wrapConditionalExpressionError(Error{
		...
		{`import nonlocal`, func(t *test, tk Tokens) { // 30
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{`lazy import nonlocal`, func(t *test, tk Tokens) { // 31
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
		...
		{`global nonlocal`, func(t *test, tk Tokens) { // 32
			t.Err = Error{
				Err: Error{
					Err:     ErrMissingIdentifier,
		...
		{`nonlocal nonlocal`, func(t *test, tk Tokens) { // 33
			t.Err = Error{
				Err: Error{
					Err:     ErrMissingIdentifier,
		...
		{`type nonlocal[a] = b`, func(t *test, tk Tokens) { // 34
			t.Err = Error{
				Err: Error{
					Err:     ErrMissingIdentifier,
		...
		{`a=yield nonlocal`, func(t *test, tk Tokens) { // 35
			t.InReturnable = true
			t.Err = Error{
				Err: Error{
					Err: Error{
		...
		{`a:nonlocal`, func(t *test, tk Tokens) { // 36
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: wrapConditionalExpressionError(Error{
		...
		{`a/=nonlocal`, func(t *test, tk Tokens) { // 37
			t.Err = Error{
				Err: Error{
					Err: Error{
						Err: Error{
